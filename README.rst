...
+-----------------------------------+-----------------------------------------------------------+
| ``f`` + ``char``                  | [count] move to the next occurrence of char               |
+-----------------------------------+-----------------------------------------------------------+
| ``F`` + ``char``                  | [count] move to the previous occurrence of char           |
+-----------------------------------+-----------------------------------------------------------+
| ``t`` + ``char``                  | [count] move till before the next occurrence of char      |
+-----------------------------------+-----------------------------------------------------------+
| ``T`` + ``char``                  | [count] move till after the previous occurrence of char   |
+-----------------------------------+-----------------------------------------------------------+
| ``;``                             | [count] repeat the last jump (f,F,t,T)                    |
+-----------------------------------+-----------------------------------------------------------+
| ``,``                             | [count] repeat the last jump (f,F,t,T) in reverse         |
+-----------------------------------+-----------------------------------------------------------+
